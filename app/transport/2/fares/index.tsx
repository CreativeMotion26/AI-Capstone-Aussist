          ...
          <View style={styles.contentContainer}>
              ...
              >
                ...
                >
                  ...
                  <View style={styles.cardTitleContainer}>
                    <Text style={styles.cardTitle}>{fareType.title}</Text>
                    <Text style={styles.cardHeaderDesc}>{fareType.desc}</Text>
                  </View>
                  <MaterialIcons 
            ...
            <View style={[styles.fareCard, expandedCards['peakTime'] && styles.expandedCard]}>
              ...
              >
                ...
                <View style={styles.cardTitleContainer}>
                  <Text style={styles.cardTitle}>Peak Time</Text>
                  <Text style={styles.cardHeaderDesc}>Check out the peak time fares for each transport type</Text>
                </View>
                <MaterialIcons 
                ...
                <View style={styles.fareTableContainer}>
                  <View style={styles.peakTimeTableContainer}>
                    <View style={styles.peakTimeTableHeader}>
                      <Text style={[styles.tableHeaderText, styles.peakTimeTitleCell]}>Time</Text>
                    ...
                    {Object.entries(peakTimeInfo).map(([key, info], index) => (
                      <View key={key} style={[styles.peakTimeTableRow, index % 2 === 0 && styles.evenRow]}>
                        <Text style={[styles.tableCell, styles.peakTimeTitleCell]}>{info.title}</Text>
                        {key === 'evening' ? (
            ...
            >
              ...
              >
                ...
                <View style={styles.cardTitleContainer}>
                  <Text style={styles.cardTitle}>Daily and Weekly Caps</Text>
                  <Text style={styles.cardHeaderDesc}>You never pay more than below within the Opal network:</Text>
                </View>
                <MaterialIcons 
