...
export default function TISPage() {
  ...
  const PhoneNumberLink = () => (
    ...
    >
      ...
      <Text style={{ color: theme.colors.primary, fontWeight: 'bold', textDecorationLine: 'underline', fontSize: 16 }}>{tisNumber}</Text>
    </TouchableOpacity>
  );
          ...
          <View style={{
            ...
            <View style={{
              ...
              >
                ...
                <Text style={{ color: theme.colors.primary, fontWeight: 'bold', fontSize: 18 }}>131 450</Text>
              </TouchableOpacity>
            </View>
          </View>
