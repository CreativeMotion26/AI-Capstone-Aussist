          ...
          <View style={styles.servicesContainer}>
            ...
            <View style={styles.cardContainer}>
              ...
              >
                ...
                <View style={styles.textContainer}>
                  <Text style={styles.serviceTitle}>{ticketOptions[0].title}</Text>
                  <Text style={styles.serviceDesc}>{ticketOptions[0].desc}</Text>
                </View>
                <MaterialIcons
            ...
            {ticketOptions.slice(1).map((option) => (
              <TouchableOpacity
                ...
                onPress={() => {
                  if (option.id === '2') {
                    router.push('/transport/2/fares');
                  } else if (option.id === '3') {
                    router.push('/transport/2/manage');
                  }
                }}
              >
